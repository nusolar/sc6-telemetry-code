...
(function() {
  var BatteryBox, Button, Camera, Drive, Gap, MainTable, Map, Toggle, namespace,
    __slice = [].slice,
  ...
  */
  ...
  Toggle = (function() {
    ...
    Toggle.prototype.controller = {
      'change:state': function() {
        ...
        return this.model.set({
          text: this.model.get('state') ? this.model.get('on') : this.model.get('off')
        });
      },
      'mousedown &': function() {
      ...
      'create': function() {
        this.view.$().addClass('DriveToggle');
        return this.model.set({
          'state': this.model.get('state')
        });
      }
    ...
    function Toggle(args) {
      ...
      this.model = {
        ...
        on: (_ref2 = args.on) != null ? _ref2 : "ON",
        off: (_ref3 = args.off) != null ? _ref3 : (_ref4 = args.on) != null ? _ref4 : "OFF",
        text: ""
      };
    }
  ...
  Drive = (function(_super) {
    ...
    Drive.Controller = (function() {
      ...
      Controller.prototype['create'] = function() {
        this.append(this.start = $$(new Toggle({
          on: "MOTOR IS ON",
          off: "MOTOR IS OFF",
          state: false
        })));
