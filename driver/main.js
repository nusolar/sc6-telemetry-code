...
(function() {
  var BatteryBox, Button, Camera, Drive, Gap, MainTable, Map, MotorToggle, ToggleController, namespace,
    __slice = [].slice,
  ...
  */
  ...
  MotorToggle = (function() {
    MotorToggle.prototype.mousedown = false;

    MotorToggle.prototype.controller = {
      'change:state': function() {
        this.view.$().css({
          'background-color': this.model.get('state') ? '#FFFF33' : ''
        });
        return this.model.set({
          text: this.model.get('state') ? this.model.get('on_text') : this.model.get('off_text')
        });
      },
      'mousedown &': function() {
      ...
      'create': function() {
        this.view.$().addClass('MotorToggle');
        return this.model.set({
          'state': this.model.get('state')
        });
      }
    ...
    function MotorToggle(args) {
      var _ref, _ref1, _ref2, _ref3, _ref4;
      if (args == null) {
        args = {};
      }
      this.toggle = (_ref = args.toggle) != null ? _ref : function() {};
      this.view = {
        format: $('#button_template').html()
      };
      this.model = {
        state: (_ref1 = args.initial) != null ? _ref1 : false,
        on_text: (_ref2 = args.on_text) != null ? _ref2 : "ON",
        off_text: (_ref3 = args.off_text) != null ? _ref3 : (_ref4 = args.on) != null ? _ref4 : "OFF",
        text: ""
      };
    }
  ...
  ToggleController = (function() {
    ...
    ToggleController.prototype['create'] = function() {
      return this.mousedown = false;
    };
  ...
  Drive = (function(_super) {
    ...
    Drive.Controller = (function() {
      ...
      Controller.prototype['create'] = function() {
        this.append(this.start = $$(new MotorToggle({
          on_text: "MOTOR IS ON",
  ...
  MainTable = (function(_super) {
    ...
    MainTable.Controller = (function() {
      ...
      Controller.prototype['create'] = function() {
        ...
        this.append($$(new Gap()), '.RightPanel');
